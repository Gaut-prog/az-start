...
class RequestStep extends Model
{
    ...
    protected $table = 'workspace_requests_steps';
    ...
    {
        return $this->belongsToMany(Item::class, 'workspace_requests_steps_position', 'request_step_id', 'request_id', 'step_id', 'Items_Numbers')
